...
const NavBar=()=> {
    ...
    return (
        <div className={`bg-[#ffffff] text-[rgb(26, 32, 44)] border-b-[1px] ${menu?"-left-[0px] back":"-left-[300px]"} flex font-[Raleway] h-[70px] px-3 justify-between md:justify-evenly items-center flex-row`}>
            ...
            <div className='hidden md:flex'>
                ...
                {/* <ul className='text-[16px]  font-[Raleway] font-semibold flex flex-row'>
                    ...
                    <NavLink to={'TimeTable'} className={'relative'}><li className='onHover relative p-1 m-1'>Time-Table</li></NavLink>
                    <NavLink to={'LiveLoc'} className={'relative'}><li className='onHover relative p-1 m-1'>Live Location</li></NavLink>
                </ul> */}
            </div>
            <div className='hidden md:flex'>
            ...
            <div className={`flex z-[1400] bg-[#ffffff] ${menu?"-left-[0px]":"-left-[300px]"} top-0 h-full w-[300px] max-w-[400px] flex-col md:hidden duration-500 absolute`}>
                <div className=' border-b-[1px]  border-[#333333]'>
                    <div className='flex h-[70px] flex-row justify-between items-center p-2 mx-2'>
                        <div className='text-2xl font-bold'>TrackME</div>
